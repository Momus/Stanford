...
;; divide-and-conquer algorithm covered in the video lectures. The
;; numeric answer for the given input file should be typed in the space
;; below.  So if your answer is 1198233847, then just type 1198233847 in
;; the space provided without any space / commas / any other punctuation
;; marks. You can make up to 5 attempts, and we'll use the best one for
;; grading.  (We do not require you to submit your code, so feel free to
;; use any programming language you want --- just type the final numeric
